...
@interface TAQNDnsResponse : TAQNDnsMessage

@property(nonatomic, assign, readonly)NSInteger timestamp;
@property(nonatomic, assign, readonly)TAQNRecordSource source;
@property(nonatomic,   copy, readonly)NSString *server;
@property(nonatomic, strong, readonly)TAQNDnsRequest *request;
...
@property(nonatomic,   copy, readonly)NSArray <TAQNRecord *> *answerArray;
@property(nonatomic,   copy, readonly)NSArray <TAQNRecord *> *authorityArray;
@property(nonatomic,   copy, readonly)NSArray <TAQNRecord *> *additionalArray;

+ (instancetype)dnsResponse:(NSString *)server source:(TAQNRecordSource)source request:(TAQNDnsRequest *)request dnsRecordData:(NSData *)recordData error:(NSError **)error;
