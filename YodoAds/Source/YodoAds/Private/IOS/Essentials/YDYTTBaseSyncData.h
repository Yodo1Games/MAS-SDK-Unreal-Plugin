...
static td_force_inline void ydy___td_td_swizzleWithOriSELStr(id target, NSString *oriSELStr, SEL newSEL, IMP newIMP) {
...
@interface YDYTTBaseSyncData : NSObject<YDYTTThirdPartySyncProtocol>
