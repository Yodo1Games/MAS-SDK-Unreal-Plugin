...
static YABannerAdDelegate* BannerAdDelegate;
#endif

void UYodoAdsBanner::SetSize(EYABannerSize Size)
{
	UE_LOG(LogTemp, Verbose, TEXT("UYodoAdsBanner::SetSize"));
...
#if PLATFORM_ANDROID
	YAMethodCallUtils::CallStaticVoidMethod(UYodoAdsLibrary::YodoAdsClassName, "setBannerSize","(Lcom/yodo1/mas/banner/Yodo1MasBannerAdView;I)V", JavaObject, (int) Size);
	YAMethodCallUtils::CallStaticVoidMethod(UYodoAdsLibrary::YodoAdsClassName, "addBannerToRootView","(Lcom/yodo1/mas/banner/Yodo1MasBannerAdView;I)V", JavaObject, (int) Size);
...
{
	UE_LOG(LogTemp, Verbose, TEXT("UYodoAdsBanner::SetPlacement"));
...
{
	UE_LOG(LogTemp, Verbose, TEXT("UYodoAdsBanner::LoadAd"));
...
{
	UE_LOG(LogTemp, Verbose, TEXT("UYodoAdsBanner::Show"));
...
{
	UE_LOG(LogTemp, Verbose, TEXT("UYodoAdsBanner::Destroy"));
